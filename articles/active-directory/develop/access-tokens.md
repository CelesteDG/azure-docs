...
The Azure AD middleware has built-in capabilities for validating access tokens, and you can browse through our [v1.0 samples](sample-v1-code.md) or [v2.0 samples](sample-v2-code.md) to find one in the language of your choice. For more information on how to explicitly validate a JWT token, see the [manual JWT validation sample](https://github.com/Azure-Samples/active-directory-dotnet-webapi-manual-jwt-validation). 
